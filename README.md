...
| [sandbox-mcp](cmd/sandbox-mcp) | MCP server that gives every session a fresh, isolated Docker container instead of a static SSH host, reusing ssh-mcp's session pool and tool surface |
