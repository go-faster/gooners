...
func TestMachineKeys(t *testing.T) {
	tests := []struct {
		...
		{"root@192.168.1.1:222", []string{"root@192.168.1.1:222", "root@192.168.1.1", "192.168.1.1:222", "192.168.1.1"}},
		{"root@192.168.1.1", []string{"root@192.168.1.1", "192.168.1.1"}},
		{"[fe80::1]", []string{"[fe80::1]"}},
		{"[fe80::1]:222", []string{"[fe80::1]:222", "fe80::1"}},
		{"root@[fe80::1]:222", []string{"root@[fe80::1]:222", "root@fe80::1", "[fe80::1]:222", "fe80::1"}},
		{"root@[fe80::1]", []string{"root@[fe80::1]", "[fe80::1]"}},
	}
